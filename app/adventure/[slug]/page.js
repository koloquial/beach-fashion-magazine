    ...
    <div className='page-container'>
      ...
      <p className='small-text'>{adventure.date}</p>
        ...
        {console.log(currentChapter)}
          {currentChapter.id === "1" && <p><img className='article-image-1' src={`${process.env.NEXT_PUBLIC_API}${adventure.images[0]}`} />{adventure.introduction}</p>}

          <h2>{currentChapter.headline}</h2>
          <img className='article-image-2' src={`${process.env.NEXT_PUBLIC_API}${currentChapter.image}`} />
